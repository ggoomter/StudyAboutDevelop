...
# 스프링의 역사
2002년 로드존슨(Rod Johnson)이 출판한 도서 Export One-on-One J2EE Design and Development에 선보인 개념과 약 3만줄의 예제 코드가 있는데 개발자들이 열광하고 데모로 끝내기에 너무 아깝다고 계속 발전하자고 한다. 그것이 스프링의 근간이 된다. 여러 개발자들이 오픈소스로 참여하며 버전업하였다.
...
2. MVC2패턴
   ...
   3. 백단에서 dom변환을 해야했을경우 out.print("<tr><td>" +id +"</td><td>")
