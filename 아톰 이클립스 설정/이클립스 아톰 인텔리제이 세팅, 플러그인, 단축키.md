...
8. ESLint 	:	자바스크립트 소스코드 분석. 자기가 직접 규칙을 만들어야함.
...
19. **file-icons** 파일확장자에 맞게 아이콘 표시
...
# 이클립스, STS
  ...
  1. 톰캣 연결
  1. web설치  (Help - eclipse Marketplace에서 popular탭의 Java and Web developer tool 설치)
